        ...
        <div className="ukrainianCeramics-container">
            <div className="leftColumn">
                <div className="leftImage-container">
                    <img src={images["gorschykX.png"]}></img>
                </div>
                <div className="leftImage-container">
                    <img src={images["gorschykH.png"]}></img>
                </div>
                <div className="leftImage-container">
                    <img src={images["gorschykH_1.png"]}></img>
                </div>
            </div>
            <div className="rightColumn">
                <div className="grid2x2Row">
                    <div><img src={images["gorschykX_1.png"]}></img></div>
                    <div><img src={images["gorschykX_2.png"]}></img></div>
                </div>
                <div className="grid2x2Row">
                    <div><img src={images["glechyk_1.png"]}></img></div>
                    <div><img src={images["glechyk_2.png"]}></img></div>
                </div>
                <div>
                    <div><img src={images["glechyk.png"]}></img></div>
                </div>
