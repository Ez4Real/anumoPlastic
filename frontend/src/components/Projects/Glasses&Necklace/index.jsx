  ...
  return (
    <Container px="0">
        ...
        >
          ...
          >
            <Image
              src={glassesAndNecklace}
              alt="Glasses And Necklace"
            ></Image>
          </GridItem>
          <GridItem
            order={[0, 1]}
          ...
          <Text
            fontSize={["12px", "16px"]}
          >{t('ProjectsPage.projects.glasses&Necklace.description')}</Text>
        </GridItem>
