      ...
      >
        ...
        >
          <GridItem
            colSpan={[2, 1]}
            order={0}
          ><Image src={trays_3} alt="Tray"></Image></GridItem>
          <GridItem
            order={[2, 1]}
          ><Image src={trays} alt="Tray"></Image></GridItem>
        ...
        >
          ...
          <GridItem
            order={[1, 1]}
            colSpan={[2, 1]}
          ><Image src={trays_1} alt="Tray"></Image></GridItem>
          <GridItem
            order={[1, 2]}
          ><Image src={trays_2} alt="Tray"></Image></GridItem>
        </Grid>
      </Flex>
    </Container>
  );
