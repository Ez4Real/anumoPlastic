    ...
    const { t } = useTranslation(); return (
        <>
            <Grid templateColumns="repeat(2, 1fr)" gap={gridGap} order={[1, 0]}>
                <Box><Image h="100%" src={gorschykX_1} alt="Gorschyk X" /></Box>
                <Box><Image h="100%" src={gorschykX_2} alt="Gorschyk X" /></Box>
                <Box><Image h="100%" src={glechyk_1} alt="Glechyk" /></Box>
                <Box><Image h="100%" src={glechyk_2} alt="Glechyk" /></Box>
            </Grid>
            <Box order={[2, 1]}>
