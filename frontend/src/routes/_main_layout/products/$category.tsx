...
import { CarabinerTags, OpenAPI } from "../../../client"
import { type ProductPublic, ProductsService } from "../../../client/index.ts"
...
function getProductsByCategoryQueryOptions({ category }: { category: string }) {
  return {
    queryFn: () => ProductsService.readProductsByCategory({ category }),
                  ...
                  <Flex gap="12px">
                    {Object.values(CarabinerTags).map((productTag, index) => (
                      <Box
                        ...
                        borderBottom={
                          tag === productTag ? "1px solid black" : "none"
                        }
                      >
                        <Image
                          key={index}
                  ...
                  <Flex gap="12px" fontWeight="600" lineHeight="19px">
                    {(currentLang === "en"
                      ...
                      <Box
                        ...
                        borderBottom={
                          size === productSize ? "1px solid black" : "none"
                        }
                      >
                        {productSize}
                      </Box>
