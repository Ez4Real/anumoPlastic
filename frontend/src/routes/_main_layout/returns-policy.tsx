  ...
  <Container px={["24px", "48px"]}>
    ...
    >
      ...
      <Heading
        ...
        fontWeight="600"
        mt="16px"
      >{t('RefundPolicy.returnPeriod.title')}</Heading>
      <VStack
        mt="10px"
        spacing="10px"
        alignItems="flex-start"
      >
        ...
        <Text>{t('RefundPolicy.returnPeriod.info.2')}{ OpenAPI.ANUMO_EMAIL }.</Text>
      ...
      <Heading
        ...
        fontWeight="600"
        mt="16px"
      >{t('RefundPolicy.damagesAndIssues.title')}</Heading>
      ...
      <Heading
        ...
        fontWeight="600"
        mt="16px"
      >{t('RefundPolicy.exceptions.title')}</Heading>
      <VStack
        mt="10px"
        spacing="10px"
        alignItems="flex-start"
      ...
      <Heading
        ...
        fontWeight="600"
        mt="16px"
      >{t('RefundPolicy.exchanges.title')}</Heading>
      <VStack
        mt="10px"
        spacing="10px"
      >
      ...
      <Heading
        ...
        fontWeight="600"
        mt="16px"
      >{t('RefundPolicy.refunds.title')}</Heading>
      <VStack
        mt="10px"
        spacing="10px"
        alignItems="flex-start"
      >
        ...
        <Text>{t('RefundPolicy.refunds.info.2')}{ OpenAPI.ANUMO_EMAIL }.</Text>
      </VStack>
